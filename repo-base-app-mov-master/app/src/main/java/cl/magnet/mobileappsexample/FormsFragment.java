...
public class FormsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mName = (EditText) getActivity().findViewById(R.id.textName);
        mDate = (EditText) getActivity().findViewById(R.id.textDate);

        //ViewModelProviders.of(this.get(FromViewModel.class);
    }
